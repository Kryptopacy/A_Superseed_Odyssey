    ...
    try:
        game_state = {
            'player': {
                ...
                'optimism_ring_fill': player.optimism_ring_fill,
                'optimism_ring_fill_rate': player.optimism_ring_fill_rate,
                'optimism_ring_duration': player.optimism_ring_duration,
                'optimism_ring_timer': player.optimism_ring_timer,
                'optimism_ring_cooldown': player.optimism_ring_cooldown,
                'optimism_ring_active': player.optimism_ring_active,
